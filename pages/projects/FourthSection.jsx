    ...
    return (
        <div className={"container"}>
            <div className={"grid grid-cols-3 gap-7 pb-4"}>
                <div className={type === "first" ? "relative row-start-1 row-end-3 card-projects overflow-hidden" : "relative row-start-1 row-end-3 col-start-3 col-end-4 card-projects overflow-hidden"}>
